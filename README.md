...
| [data-reasoning](https://github.com/briandconnelly/data-reasoning) | Skills for reasoning from data — exploratory analysis that generates honest leads, and hypothesis-driven investigation that adjudicates them |
